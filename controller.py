...
# Funciones auxiliares adaptadas para múltiples switches
...
class DDoSML(app_manager.RyuApp):
    ...
    def _activate_prevention(self, dpid):
        ...
        # Bloquear puertos sospechosos (ejemplo simplificado)
    ...
    def _packet_in_handler(self, ev):
        ...
        # Inicializar estructuras para este switch si no existen
        self.mac_to_port.setdefault(dpid, {})
        self.arp_ip_to_port.setdefault(dpid, {})
